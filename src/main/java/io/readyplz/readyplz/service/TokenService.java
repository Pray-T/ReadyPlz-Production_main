...
public class TokenService {
    ...
    public void saveAccessToken(String username, String token, long expirationTime) {
        ...
        redisTemplate.opsForValue().set(key, Objects.requireNonNull(token), expirationTime, TimeUnit.MILLISECONDS);
    ...
    public void deleteUserTokens(String username) {
        ...
        redisTemplate.delete(Objects.requireNonNull(java.util.Arrays.asList(accessKey, refreshKey)));
